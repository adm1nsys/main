  ...
  document.getElementById("cursor2").style.overflow = "hidden";
  ...
  setTimeout(
    function() {
      if (i < output.length - 2)
        ...
        document.getElementById("cursor2").style.cursor = "auto";
        document.getElementById("cursor2").style.overflow = "auto";
        document.getElementById("cursor2").style.overflowX = "hidden";
